  ...
  return (
    <>
      ...
      >
        <div className="mm">
          <div
            className="headchat d-flex align-items-center bg-danger"
            style={{ height: "12%"}}
          >
            <h1 className="ps-3 hh2">CanVTalk</h1>
          </div>
          ...
          <div className="inputbox px-2 py-2 d-flex" style={{ height: "12%" ,width:"100%"}}>
            ...
            <button onClick={()=>send()} className="btt" style={{ width: "30%" }}><i class="fa-solid fa-share"></i></button>
          </div>
        </div>
      </div>
    </>
